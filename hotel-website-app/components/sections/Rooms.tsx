...
export function Rooms() {
  ...
  return (
    <section id="rooms" ref={ref} style={{
      padding:    "120px 40px",
      background: "#0d0d0d",
    }}>
      <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
        ...
        >
          ...
          <p style={{
            ...
            Each room is thoughtfully designed to offer comfort, elegance,
            and a sense of calm.
          </p>
        </motion.div>
              ...
              <div style={{ padding: "28px" }}>
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    onMouseLeave={e => {
                      e.currentTarget.style.background = room.featured ? "var(--gold)" : "transparent";
                      e.currentTarget.style.color      = room.featured ? "#0B0B0B" : "var(--gold)";
                    }}
                  >
                    Book
                  </a>
